<x-app-layout>
            ...
            <table class="w-full whitespace-nowrap min-w-[800px] xl:min-w-full xl:whitespace-normal">
                <thead>
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                        ...
                        <th class="px-4 py-3 w-1/6">Marca</th>
                        <th class="px-4 py-3 w-1/6">Tipo de Equipo</th>
                        <th class="px-4 py-3 w-1/6">Estado</th>
                        <th class="px-4 py-3 w-1/6">Ubicación</th>
                        <th class="px-4 py-3 w-1/6">Responsable</th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        <td class="px-4 py-3">
                            <div class="flex items-center text-sm">
                                <div>
                                    <p class="font-semibold truncate">{{ $equipo->nombre }}</p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-4 text-sm">
                                <a href="{{ url('/equipos/' . $equipo->id . '/edit') }}" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                    aria-label="Edit">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                    </svg>
                                </a>
                                <form action="{{ url('/equipos/' . $equipo->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
    ...
    <form action="{{ url('/equipos/save') }}" method="POST" class="max-w-md mx-auto">
        @csrf
