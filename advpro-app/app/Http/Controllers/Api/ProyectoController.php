...
use App\Models\Contrato; // Importar el modelo Contrato para el dashboard
use Barryvdh\DomPDF\Facade\Pdf; // Uso para los reportes
use Carbon\Carbon; // Manejo de fechas

class ProyectoController extends Controller
{
 
    protected function applyProjectFilters(Request $request, $query)
    {
    ...
    public function index(Request $request)
    {
        ...
        $query = $this->applyProjectFilters($request, $query);
